...
export default function AdminCategoriesPage() {
  return (
    <div className="p-6 md:p-10 space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          <Typography variant="displaySm" className="text-3xl md:text-4xl font-black uppercase tracking-tighter">Taxonomy Engine</Typography>
          <Typography variant="bodyMd" className="text-bazar-gray-500 mt-2 font-medium">Manage the global platform category tree and sub-taxonomies.</Typography>
        </div>
        <div className="flex items-center gap-3">
           <Button variant="outline" size="sm" className="h-10 px-4 gap-2 text-[10px] font-black uppercase tracking-widest rounded-xl">
             <Info className="w-3.5 h-3.5 opacity-40" /> Taxonomy Guide
           </Button>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-12 gap-10">
         ...
         <div className="lg:col-span-4 space-y-8">
            <Card className="p-6 border-bazar-gray-200 dark:border-bazar-gray-800 bg-bazar-white dark:bg-bazar-black rounded-3xl">
               ...
               <div className="space-y-6">
                  ...
                  <StatRow label="Active Sub-categories" value="42" />
                  <StatRow label="Deepest Hierarchy" value="3 Levels" />
                  <StatRow label="Orphaned Products" value="0" />
               </div>
            </Card>

            <Card variant="dark" className="bg-bazar-black text-white p-6 rounded-3xl relative overflow-hidden">
               ...
               <Typography variant="bodySm" className="text-[11px] text-bazar-gray-400 mb-6 leading-relaxed">
                  The Bazaar Intelligence engine automatically categorizes new vendor products based on this taxonomy.
               </Typography>
               <Button className="w-full bg-white text-black h-9 text-[10px] font-black uppercase tracking-widest rounded-xl">
                  Recalibrate Engine
               </Button>
            </Card>
