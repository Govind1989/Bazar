    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredVendors.map((vendor) => {
          const isFollowed = user.followedVendors.includes(vendor.id);
          
          return (
            <Card key={vendor.id} className="p-0 border-2 border-bazar-gray-100 dark:border-bazar-gray-900 group hover:border-bazar-black dark:hover:border-bazar-white transition-all overflow-hidden">
               <div className="p-6">
                  <div className="flex justify-between items-start mb-4">
                     <div className="w-16 h-16 rounded-2xl bg-bazar-gray-50 dark:bg-bazar-gray-950 p-3 overflow-hidden">
                  ...
                  <div className="space-y-2">
                     <Typography variant="titleSm" className="font-black text-lg line-clamp-1">{vendor.name}</Typography>
                     <Typography variant="bodySm" className="text-xs opacity-60 line-clamp-2 leading-relaxed">{vendor.description}</Typography>
                  </div>
                  
                  <div className="mt-6 pt-4 border-t border-bazar-gray-50 dark:border-bazar-gray-950 flex items-center justify-between">
